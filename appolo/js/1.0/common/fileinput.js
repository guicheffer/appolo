...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Aquivo "{name}" (<b>{size} KB</b>) excedeu o tamanho máximo permitido de <b>{maxSize} KB</b>. Por favor tente novamente!',
        msgFilesTooMany: 'Numero de arquivos selecionado para uploads <b>({n})</b> ultrapassa o máximo permitido de <b>{m}</b>. Por favor tente novamente!',
        msgFileNotFound: 'Arquivo "{name}" não encontrado!',
        msgFileNotReadable: 'Arquivo "{name}" não é legível.',
        msgFilePreviewAborted: 'Upload cancelado por "{name}".',
        msgFilePreviewError: 'Um erro ocorreu ao tentar ler o arquivo "{name}".',
        msgInvalidFileType: 'Tipo inválido para o aquivo "{name}". Somente "{types}" são suportados.',
        msgInvalidFileExtension: 'Extensão do arquivo inválida"{name}". Somente "{extensions}" são suportados.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Erro no processo de Upload</span>',
