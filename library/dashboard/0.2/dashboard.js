folha.dashboard = {
    ...
    genericObjects: {
        ...
        /**
        * Funções de comparação para se usar com o sort(), ex: meu_array.sort( dashboard.sort_by.object.property_value( array_obj , property , asc , case_sensitive ) )
        *
        * @class sort_by
        * @constructor none
        */
        sort_by: { 
            ...
            /**
            * Funções de comparação para um array de objetos.
            *
            * @class object
            * @constructor none
            */
            ...
            date: {
                ...
                */
                timestamp_to: {
                    ...
                    * @param {String} splitter O que será inserido entre cada valor , default '/'
        ...
        * @param {String} content considera que é o provider
        ...
        * @constructor none
        */
        // FIXME:2012-09-12:thiago.morelli:Não sofreu manutenção a partir da versão 0.1
        cacheController: {
        ...
        /**
        * Funções para lidar com url, tanto campo search como hash.
        *
        * @class url_controller
        * @constructor none
        */
        // FIXEME:2012-09-12:thiago.morelli:Com exceção dos métodos com comentários, os demais não foram atualizados da versão 0.1
        url_controller: {
            ...
            * @param {Array} url_vars lista das propriedades do {values} que serão usados, qualquer propriedade que não esteja nessa lista não participa
            * @param {Array} url_splitters lista os separadores, de valores, de propriedade->valor e entre propriedades, ex: [ ',' , '=' , '&' ]
            * @param {Boolean} add se true adiciona no fim do hash/search, senão substituí, default false
        ...
        * @constructor none
        */
        // FIXEME:2012-09-12:thiago.morelli:Não sofreu manutenção a partir da versão 0.1
        loadController: {
